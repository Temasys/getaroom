/*! skylinkjs - v0.6.8 - Wed Jan 20 2016 17:18:03 GMT+0800 (SGT) */
...
Skylink.prototype._groupMessageList = [
  ...
  // Note to prevent room locking from being queued
 ...
 * @attribute RECORDING_STATES
 * @type JSON
 * @for Skylink
 */
Skylink.prototype.RECORDING_STATES = {
  START: 0,
  STOP: 1,
  LINK: 2,
  ERROR: -1,
 ...
 * @for Skylink
 */
// Skylink.prototype._EVENTS.recordingState = [];
...
/**
 * Handles the "recordingEvent" message.
